...
Label: wayfinder:map
Status: **destination reached 2026-07-22** — [SPEC.md](../../SPEC.md) written, [Spec assembly](issues/13-spec-assembly.md) closed. Remaining open tasks ([Register FinTS product ID](issues/14-fints-product-id-registration.md), [Apply for scalable-cli beta](issues/15-scalable-cli-beta.md), [Verify CSV formats against real exports](issues/19-csv-format-verification.md)) are build-effort inputs (SPEC.md §15), not map decisions.
